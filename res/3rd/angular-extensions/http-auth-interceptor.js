...
(function () {
  ...
  .factory('httpBuffer', ['$injector', '$sessionStorage', function($injector, $sessionStorage) {
    ...
    function retryHttpRequest(config, deferred) {
      ...
      if (sn && si) {
        ...
        config.headers.sid = $http.defaults.headers.common[sn];
      }
    ...
    return {
      ...
      append: function(config, deferred) {
        if (config && config.url != 'logout' && config.url != 'login') {
          buffer.push({
            config: config,
            deferred: deferred
          });
